...
export class Backend implements backendInterface {
    ...
    async getTeamCount(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getTeamCount();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async registerTeam(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.registerTeam(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
